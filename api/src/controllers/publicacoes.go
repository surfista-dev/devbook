...
// BuscarPublicacoes traz as publicações que aparece no feed do usuário
...
// AtualizarPublicação Atera os dados de uma publicação
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New(" Não e possível atualizar uma publicação que não seja a sua"))
		return
	}
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New(" Não e possível Deletar uma publicação que não seja a sua"))
		return
	}
...
//BuscarPublicacoesPorUsuario tras todas as publicações de um usuário específico
